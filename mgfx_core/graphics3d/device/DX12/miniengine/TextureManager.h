...
public:
    ...
    void Create(size_t Pitch, size_t Width, size_t Height, DXGI_FORMAT Format, const void* InitData = nullptr);
    void Create(size_t Width, size_t Height, DXGI_FORMAT Format, const void* InitData = nullptr )
    {
