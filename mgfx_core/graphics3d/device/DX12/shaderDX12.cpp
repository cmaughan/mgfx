...
uint32_t LoadShaders(const fs::path& vertex_file_path, const fs::path& fragment_file_path)
{
    ...
    {
        UIManager::Instance().AddMessage(MessageType::Error | MessageType::System, "Couldn't load shader: " + vertex_file_path.string());
    ...
    {
        UIManager::Instance().AddMessage(MessageType::Error | MessageType::System, "Couldn't load shader: " + fragment_file_path.string());
